...
public class MainActivity extends AppCompatActivity {
    ...
    static final String MEALS_LAUNDRY_FRAGMENT_TAG = "MEALS_LAUNDRY_FRAGMENT_TAG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            } else if (item.getItemId() == R.id.item_meals_laundry) {
                selectedFragmentTag = MEALS_LAUNDRY_FRAGMENT_TAG;
                selectedFragment = getSupportFragmentManager().findFragmentByTag(selectedFragmentTag);

                if (selectedFragment == null) {
                    selectedFragment = new MealsLaundryFragment();
                }
