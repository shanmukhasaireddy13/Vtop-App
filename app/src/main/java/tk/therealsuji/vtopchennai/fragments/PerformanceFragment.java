        ...
        getParentFragmentManager().setFragmentResultListener("customInsets", getViewLifecycleOwner(), (requestKey, result) -> {
            ...
            this.marks.setPageTransformer((page, position) -> {
                ...
                ((ViewGroup) page).getChildAt(0).setPadding(
                        ...
                        0,
                        systemWindowInsetRight,
                        (int) (finalBottomNavigationHeight + 20 * pixelDensity + headerOffset)
                );
            });
        });
        ...
        marksDao.getCourses()
                ...
                .subscribe(new SingleObserver<List<Course.AllData>>() {
                    ...
                    public void onSuccess(@NonNull List<Course.AllData> courses) {
                        ...
                        tabLayoutMediator = new TabLayoutMediator(courseTabs, marks, (tab, position) -> {
